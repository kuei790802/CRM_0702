...
CREATE TABLE `events` (
  ...
  `salespersonname` varchar(100) DEFAULT NULL COMMENT '業務人員姓名',
  `customerid` bigint(20) DEFAULT NULL COMMENT '關聯客戶',
  `opportunityid` bigint(20) DEFAULT NULL COMMENT '關聯商機',
...
CREATE TABLE `opportunities` (
  `opportuntiyid` bigint(20) NOT NULL COMMENT '商機編號',
  `customerid` bigint(20) NOT NULL COMMENT '所屬客戶編號',
...
--
ALTER TABLE `opportunities`
  MODIFY `opportuntiyid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '商機編號';
...
ALTER TABLE `events`
  ...
  ADD CONSTRAINT `fk_event_customer` FOREIGN KEY (`customerid`) REFERENCES `customers` (`customerid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_event_opportunity` FOREIGN KEY (`opportunityid`) REFERENCES `opportunities` (`opportuntiyid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `quotationdetail`
  ADD CONSTRAINT `fk_qdetail_product` FOREIGN KEY (`productid`) REFERENCES `products` (`productid`) ON UPDATE CASCADE,
...
--
ALTER TABLE `quotations`
  ADD CONSTRAINT `fk_quotation_opportunity` FOREIGN KEY (`opportunityid`) REFERENCES `opportunities` (`opportuntiyid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `records`
  ...
  ADD CONSTRAINT `fk_record_opportunity` FOREIGN KEY (`opportunityid`) REFERENCES `opportunities` (`opportuntiyid`) ON DELETE CASCADE ON UPDATE CASCADE,
